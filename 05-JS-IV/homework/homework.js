...
function agregarPropiedad(objeto, property) {
  ...
  // Devuelve el objeto
  // NOTA: El nombre de la propiedad no es "propiedad", el nombre es el valor del argumento llamado "property" (una cadena/string)Tu código:
...
function pasarUsuarioAPremium(usuarios) {
  ...
  // Tu código:
  //usuarios.array.forEach((usuario)=> usuario.esPremium = true);
  //return usuarios;
